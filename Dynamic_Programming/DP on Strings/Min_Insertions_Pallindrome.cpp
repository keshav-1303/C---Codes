...
int minInsertions(string s) {
    ...
    // Max possible ans will be len(s).

    // Approach : Keep the longest pallindromic subsequence intact
    // Then those who are not in pallindrome, insert them to make pallindrome. 
